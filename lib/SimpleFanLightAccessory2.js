...
// Lightbulb Brightness
    ...
    setColorTemperature(value, callback) {
	    ...
	    console.log("Set Colour State - " + this.convertColorTemperatureFromHomeKitToTuya(value));
	     console.log("Set Colour State Inverted - " + this.invNumb(this.convertColorTemperatureFromHomeKitToTuya(value)));
    }
	invNumb(input){
	let result = input - 100;
		console.log("Input -100 = " + result);
		console.log("+result + (result * 2) = " + +result + (result * 2));
