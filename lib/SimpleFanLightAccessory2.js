...
class SimpleFanLightAccessory2 extends BaseAccessory {
	...
	if (this.useLight) {
            ...
            .updateValue(this.invNumb(this.convertColorTemperatureFromTuyaToHomeKit(dps[this.dpColorTemperature])))
	    ...
	    if (changes.hasOwnProperty(this.dpLightOn) && characterLightOn && characterLightOn.value !== changes[this.dpLightOn])
 	    ...
 	    if (changes.hasOwnProperty(this.dpColorTemperature)) {
                if (this.convertColorTemperatureFromHomeKitToTuya(characteristicColorTemperature.value) !== changes[this.dpColorTemperature])
                    characteristicColorTemperature.updateValue(this.invNumb(this.convertColorTemperatureFromTuyaToHomeKit(changes[this.dpColorTemperature])));
		    console.log("Set Characteristic Color - " + this.invNumb(this.convertColorTemperatureFromTuyaToHomeKit(changes[this.dpColorTemperature])));
            } else if (changes[this.dpBrightness]) {
                characteristicColorTemperature.updateValue(this.invNumb(this.convertColorTemperatureFromTuyaToHomeKit(state[this.dpColorTemperature])));
            }
...
// Lightbulb Brightness
    ...
    getColorTemperature(callback) {
	    ...
	    console.log("Get Colour State - " + this.convertColorTemperatureFromTuyaToHomeKit(this.device.state[this.dpColorTemperature]));
    }
