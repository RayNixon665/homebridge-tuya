...
// Lightbulb Brightness
    ...
    getColorTemperature(callback) {
	    ...
	    console.log("GetColour - " + this.convertColorTemperatureFromTuyaToHomeKit(this.device.state[this.dpColorTemperature]));
    }
    ...
    setColorTemperature(value, callback) {
	    ...
	    console.log("Set Colour - " + this.convertColorTemperatureFromHomeKitToTuya(value));
    }
