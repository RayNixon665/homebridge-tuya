...
// Fan Speed
    ...
    getRotation(dp) {
	    console.log("get Rotation Derection - " + dp);
      //  const {Characteristic} = this.hap;
        return dp;
    }

    setRotation(value, callback) {
	    console.log("Set Rotation Derection - " + value);
	    
	if (value == 0) {
		console.log("Set Rotation Derection - normal");
        	return this.setState(this.dpRotationDirection, "normal", callback);
        } else {
		console.log("Set Rotation Derection - reverse");
...
// Lightbulb Brightness
	...
	ConvertRotation(input) {
		console.log("ConvertRotation - " + input);
		return "normal";
	return input;}
