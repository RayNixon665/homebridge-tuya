...
class SimpleFanLightAccessory2 extends BaseAccessory {
	...
	if (this.useLight) {
		    ...
		    characteristicColorTemperature = serviceLightbulb.getCharacteristic(Characteristic.ColorTemperature)
            		...
            		minValue: 0,
                	maxValue: 600})
            .updateValue(this.convertColorTemperatureFromTuyaToHomeKit(this.scaleUp(dps[this.dpColorTemperature])))
            .on('get', this.getColorTemperature.bind(this))
            .on('set', this.setColorTemperature.bind(this));
			    
	console.log("MainUpdate Call Tuya Value (pre scale Up) - " + dps[this.dpColorTemperature]);
	console.log("MainUpdate Call Tuya Value (post scale Up) - " + this.scaleUp(dps[this.dpColorTemperature]));
        console.log("MainUpdate Call Converted to Homekit Value - " + this.scaleUp(this.convertColorTemperatureFromTuyaToHomeKit(dps[this.dpColorTemperature])));
