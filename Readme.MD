...
pnpm add github:RayNixon665/homebridge-tuya_RaysFork

To update using

pnpm update github:RayNixon665/homebridge-tuya_RaysFork

if pnpm is not working, run this command from terminal
